...
class MWTargetNetworkImpl {
  public:
    ...
    MWTargetNetworkImpl()
        ...
        , NmExSIssnXpisMKKatUq(0)
        , NnAKUXChhnRnQmWsknGy(0)
        , MW_autoTune(true)
        , nNULvWnBXnnWdpEkHPAH(0)
        , HJHXkKmgFxxIOsIvRRnF(0)
    {}
    ~MWTargetNetworkImpl();
  ...
  private:    
    ...
    size_t HJHXkKmgFxxIOsIvRRnF;
    float* xcusoQxPPodcHwVviCWI;    
    cublasHandle_t* NmExSIssnXpisMKKatUq;
    cudnnHandle_t* NnAKUXChhnRnQmWsknGy;
    bool MW_autoTune;
